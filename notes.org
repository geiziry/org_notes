...
**** It is good practice to assign 0 or NULL to a pointer immediately after you delete it.
...
**** A memory leak is produced when a program causes memory to be allocated and then loses track of that memory so that it can neither be accessed nor delete d.
>>>>>>> 1d358733adc439d343eebfc761f17a5949e45046
